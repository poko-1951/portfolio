...
ActiveRecord::Schema.define(version: 2022_07_04_015640) do
  ...
  create_table "acquaintances", force: :cascade do |t|
    ...
    t.string "relationship", default: "未設定", null: false
    t.string "character", default: "未設定", null: false
    t.string "like", default: "未設定", null: false
  ...
  create_table "schedules", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["acquaintance_id"], name: "index_schedules_on_acquaintance_id"
  ...
  create_table "stocks", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["acquaintance_id"], name: "index_stocks_on_acquaintance_id"
    t.index ["topic_id"], name: "index_stocks_on_topic_id"
  ...
  add_foreign_key "schedules", "acquaintances"
  add_foreign_key "schedules", "events"
  add_foreign_key "stocks", "acquaintances"
  add_foreign_key "stocks", "topics"
